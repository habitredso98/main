...
(function (global) {
    ...
    function titleText() {
        var h = barHost();
        return h ? h : 'One more step . . .';
    }

    function noteText() {
        var h = barHost();
        if (h) {
            return h + ' needs to review the security of your connection before proceeding.';
        }
        return 'Cloudflare needs to review the security of your connection before proceeding.';
    }
    ...
    function html(id) {
        return (
            ...
            '<div class="lcf-body">' +
            '<h1 class="lcf-title">' + titleText() + '</h1>' +
